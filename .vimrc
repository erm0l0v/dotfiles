...
let g:neocomplcache_max_keyword_width = 120
...
let g:autoprefixer_options = '-b "last 4 versions, > 1%"'
...
if has("autocmd")
   ...
   au!
       ...
       " Set filetypes aliases
        autocmd BufNewFile,BufRead *.nunj set filetype=html
       autocmd FileType html imap <buffer><expr><tab> <sid>zen_html_tab()
       autocmd FileType css imap <buffer><expr><tab> <sid>zen_html_tab()
       autocmd FileType htmld imap <buffer><expr><tab> <sid>zen_html_tab()
       autocmd FileType jinja imap <buffer><expr><tab> <sid>zen_html_tab()
       ...
       autocmd FileType javascript* nmap K :TernDocBrowse<CR>
       autocmd FileType javascript* setlocal spell

       autocmd BufNewFile,BufRead *Spec.js,*_spec.js,*/spec/*.js set filetype=javascript.javascript-jquery.jasmine syntax=jasmine
